...
join db_rmympt.clientes c on v.id_cliente = c.idcliente 
join db_rmympt.adm_empleado e on c.id_empleado = e.id_empleado
join db_rmympt.adm_departamentopais dp on c.iddepartamento = dp.iddepartamento
join db_rmympt.adm_municipio m on c.id_municipio = m.id_municipio
where s.estado = 1 
and v.estado > 0 
and s.saldo > 0 
and v.tipo in('E', 'F') 
          ...
          <li>
            ...
            <ul class="sub-menu2">
              <div>
                ...
                <li><a href="#">Peten</a></li>
                <li><a href="../xela">Xela</a></li>
              </div>
            </ul>
          </li>
...
table.on('draw', function () {
 ...
 document.getElementById('exportPDF').addEventListener('click', async () => {
            ...
            pdf.save('graficaSaldos.pdf'); // Descargar archivo
        });
    </script>
