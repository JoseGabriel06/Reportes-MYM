...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conexion->prepare("SELECT nombre FROM db_mymsa.adm_municipio WHERE id_departamento = (SELECT iddepartamento FROM db_mymsa.adm_departamentopais WHERE nombre = ?)");
